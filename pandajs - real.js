...
core.Class = function() {
  ...
  game.addAudio("audio/PiggybackRideLoop.m4a");
  ...
  SceneTitle = game.Scene.extend({
     ...
     */
    init : function() {
      game.audio.playMusic("audio/PiggybackRideLoop.m4a");
      /** @type {number} */
      var j = 0;
    ...
    flyOff : function() {
      if (this.flower && this.collecting) {
        ...
        if (game.scene.addScore(score), this.collecting = false, !game.scene.ended) {
          ...
          /** @type {Array} */
          this.sprite.textures = [game.Texture.fromFrame(this.name + "Fly01.png"), game.Texture.fromFrame(this.name + "Fly02.png"), game.Texture.fromFrame(this.name + "Fly03.png"), game.Texture.fromFrame(this.name + "Fly04.png"), game.Texture.fromFrame(this.name + "Fly05.png"), game.Texture.fromFrame(this.name + "Fly06.png"), game.Texture.fromFrame(this.name + "Fly07.png"), game.Texture.fromFrame(this.name + "Fly08.png")];
          /** @type {boolean} */
  ...
  TitleBee = game.Class.extend({
    ...
    init : function() {
      ...
      this.sprite = new game.Animation(this.name + "Fly01.png", this.name + "Fly02.png", this.name + "Fly03.png", this.name + "Fly04.png", this.name + "Fly05.png", this.name + "Fly06.png", this.name + "Fly07.png", this.name + "Fly08.png");
      /** @type {number} */
      this.sprite.animationSpeed = 1;
      this.sprite.play();
      this.sprite.anchor.set(0.5, 0.5);
      if (game.config.useShadows) {
        this.shadow = new game.Animation(this.name + "Fly01.png", this.name + "Fly02.png", this.name + "Fly03.png", this.name + "Fly04.png", this.name + "Fly05.png", this.name + "Fly06.png", this.name + "Fly07.png", this.name + "Fly08.png");
        /** @type {number} */
